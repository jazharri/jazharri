			...
			<div class="col-sm-12">
				<div class="row-product">
					...
					<div class="equity-content">
						<p style="line-height: 26px; text-align:justify; margin-top: 10px; margin-bottom: 0px;">Investasi saham juga ada yang halal loh! Investasi saham syariah di MNC Sekuritas sudah tersertifikasi DSN MUI loh. Bermodal Rp 100.000,- saja, Anda sudah dapat mulai berinvestasi saham. Kelas ini cocok untuk pemula, yang baru ingin memulai investasi saham secara syariah. <br>
						Melalui Klinik Edukasi Syariah (Basic), Anda dapat belajar mengenai pasar modal syariah, termasuk:</p>
						<ul>
							<li><p style="line-height: 26px; text-align:justify; margin-top: 10px; margin-bottom: 0px;">Landasan Hukum</p></li>
							<li><p style="line-height: 26px; text-align:justify; margin-top: 10px; margin-bottom: 0px;">Produk Pasar Modal Syariah</p></li>
						</ul>
						<p style="line-height: 26px; text-align:justify; margin-top: 10px; margin-bottom: 0px;">Segera daftar karena tempatnya terbatas!</p>
						<div class="clearfix">&nbsp;</div>
						<div class="clearfix">&nbsp;</div>	
						<table name="regTable" width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:18px;">
							...
							<tr>
								...
								<th valign="top">:</th>
								<th valign="top"><a href="/education/register_online?topic1=<?php echo $topic1; ?>&date1=<?php echo $date1; ?>&venue1=<?php echo $venue1; ?>&time1=<?php echo $time1; ?>&tema1=<?php echo $tema1; ?>&pic1=<?php echo $pic1; ?>" >Klik Disini</a></th>
							</tr>	
						</table>
						<div class="clearfix">&nbsp;</div>
						<div class="clearfix">&nbsp;</div>	
						<p style="line-height: 26px; text-align:justify; margin-top: 10px; margin-bottom: 0px;">Syarat mengikuti kelas adalah bersedia membuka rekening saham syariah di MNC Sekuritas<br></p>
						<p style="line-height: 26px; text-align:justify; margin-top: 10px; margin-bottom: 0px;">Informasi lebih lanjut, silahkan hubungi Call Center kami di 1 500 899 (tekan 3) atau email ke <a href="mailto:callcenter.mncs@mncgroup.com?Subject=Klinik%20Edukasi%20Syariah%20Basic" target="_top">callcenter.mncs@mncgroup.com</a></p>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
