			...
			<div class="col-sm-12">
				<div class="row-product">
					...
					<div class="equity-content">
						<p style="line-height: 26px; text-align:justify; margin-top: 10px; margin-bottom: 0px;">Kelas ini cocok bagi investor saham syariah yang sudah memiliki rekening saham di MNC Sekuritas dan telah mengikuti Klinik Edukasi Syariah (Advanced). Tema yang akan dibahas adalah analisa fundamental dan teknikal.<br>
						Klinik Edukasi Syariah (Advanced) akan diselenggarakan pada:</p>
						<div class="clearfix">&nbsp;</div>
						<div class="clearfix">&nbsp;</div>	
						<table name="regTable" width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<div class="clearfix">&nbsp;</div>
						<div class="clearfix">&nbsp;</div>	
						<p style="line-height: 26px; text-align:justify; margin-top: 10px; margin-bottom: 0px;">Informasi lebih lanjut, silahkan hubungi Call Center kami di 1 500 899 (tekan 3) atau email ke <a href="mailto:callcenter.mncs@mncgroup.com?Subject=Klinik%20Edukasi%20Syariah%20Advanced" target="_top">callcenter.mncs@mncgroup.com</a></p>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
