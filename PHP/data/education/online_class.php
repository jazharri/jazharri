...
$tema1	= cc($_GET["tema1"] != null ? $_GET["tema1"] : '');		
		...
		<div class="row row1">
			<div class="col-sm-12">
				<div class="row-product">
					<h2>Klinik Edukasi <em>Online Class</em></h2>
					<div class="equity-content">
						...
						<table name="regTable" width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:18px;">
							...
							<tr>
								...
								<th valign="top">:</th>
								<th valign="top"><?php echo $venue1; ?><br><br></th>
							</tr>
							<tr>
								<th valign="top">Tema
								<th valign="top">:</th>
								<th valign="top"><?php echo $tema1; ?><br><br></th>
							</tr>							
							<tr>
								<th valign="top">Registrasi </th>
								<th valign="top">:</th>
								<th valign="top"><a href="https://www.mncsekuritas.id/education/register_online?topic1=<?php echo $topic1; ?>&date1=<?php echo $date1; ?>&venue1=<?php echo $venue1; ?>&time1=<?php echo $time1; ?>&tema1=<?php echo $tema1; ?>" >Klik Disini</a></th>
							</tr>	
						</table>
						<div class="clearfix">&nbsp;</div>
						<div class="clearfix">&nbsp;</div>	
						<p style="line-height: 26px; text-align:justify; margin-top: 10px; margin-bottom: 0px;">Syarat mengikuti kelas adalah bersedia membuka rekening saham di MNC Sekuritas<br></p>
						<p style="line-height: 26px; text-align:justify; margin-top: 10px; margin-bottom: 0px;">Informasi lebih lanjut, silahkan hubungi Call Center kami di 1 500 899 (tekan 3) atau email ke <a href="mailto:callcenter.mncs@mncgroup.com?Subject=Klinik%20Edukasi" target="_top">callcenter.mncs@mncgroup.com</a></p>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
